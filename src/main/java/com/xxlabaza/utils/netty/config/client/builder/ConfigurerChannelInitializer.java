...
class ConfigurerChannelInitializer implements BuildContextConfigurer<NettyClientBuildContext> {

  @Override
  @SuppressWarnings("unchecked")
  public void configure (NettyClientBuildContext context) {
    val suffix = "NettyClientChannelInitializer";
  ...
  private Optional<ChannelInitializer<SocketChannel>> fromConfig (NettyClientBuildContext context) {
    return ofNullable(context.config.getChannelInitializer());
  }

  @SuppressWarnings("unchecked")
  private Optional<ChannelInitializer<SocketChannel>> fromContext (NettyClientBuildContext context) {
    val clientChannelInitializer = context.getBean(NettyClientChannelInitializer.class);
    if (clientChannelInitializer != null) {
      return of(clientChannelInitializer);
    }
