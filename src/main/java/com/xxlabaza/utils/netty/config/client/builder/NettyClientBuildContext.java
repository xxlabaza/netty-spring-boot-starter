...
/**
 * A context for building a {@link com.xxlabaza.utils.netty.NettyClient} and all attendant beans.
 */
final class NettyClientBuildContext extends BuildContext {
  ...
  @Builder
  NettyClientBuildContext (DefaultListableBeanFactory beanFactory, Environment environment, NettyClientConfig config) {
